...
function showGameScoreLayer() {
    ...
    document.getElementById('GameScoreLayer-bast').innerHTML = '睾光最佳&nbsp;&nbsp;' + bast;
    l.style.display = 'block';
}
...
function shareText(score) {
    ...
    SubmitResults();
    if (score <= 49) return '逊得跟奥运似的';
    if (score <= 99) return '哈哈哈哈哈，亿斑斑';
    if (score <= 149) return '真能踹';
    if (score <= 199) return '你可真邢啊';
    return '都撅烂了罢（恼';
}
